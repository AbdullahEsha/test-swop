        ...
        <div className="help-container">
          ...
          <div className="help-youtube">
            <div className="help-youtube-inside">
              <iframe src="https://streamable.com/e/oltdnh" frameBorder={0} />
              <p>How to Active SWOP</p>
            </div>
            <div className="help-youtube-inside">
              <iframe src="https://streamable.com/e/dqapd8" frameBorder={0} />
              <p>How to connect SWOP an Iphone</p>
            </div>
            <div className="help-youtube-inside">
              <iframe src="https://streamable.com/e/773nd5" frameBorder={0} />
              <p>How to SWOP connect an Android</p>
            </div>
            <div className="help-youtube-inside">
              <iframe src="https://streamable.com/e/qrjsrt" frameBorder={0} />
              <p>How to Active SWOP</p>
            </div>
          </div>

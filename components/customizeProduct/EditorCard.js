...
const App = () => {
  ...
  useEffect(() => {
    ...
    if (json) {
      ...
      //   if (layer.className === "Image") {
      //     items = [...items, layer.attrs];
      //   }
      // });
    }
    ...
    //     type: "image",
    //     src:
    //       "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Galaxy_S21_Logo.svg/1280px-Galaxy_S21_Logo.svg.png",
    //     id: "21-logo",
    //     hash: "Q3OTA",
    //     x: 150.91964783726962,
    //     y: 60.98084650809713,
    //     imageId: "21-logo",
    //     draggable: true,
    //     strokeWidth: 1,
    //     offsetX: 640,
    //     offsetY: 120,
    //     scaleX: 0.17855047430681098,
    //     scaleY: 0.1785504743068107
    //   }
    // ]);

    // const stage = Konva.Node.create(JSON.parse(json), "container");

    // stageRef.current = stage;

    // stage.find("Image").forEach((imageNode) => {
    //   const src = imageNode.getAttr("imageUrl");
  ...
  const saveDesign = () => {
    ...
    //   localStorage.setItem("saveImage", dataURL);
